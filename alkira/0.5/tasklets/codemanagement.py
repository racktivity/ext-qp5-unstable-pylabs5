...
def main(q, i, params, tags):
    ...
    recipe.addSource(connection, 'htdocs/', q.system.fs.joinPaths(filesexportDir, 'www'))
    recipe.addSource(connection, 'services/', q.system.fs.joinPaths(filesexportDir, 'apps', 'applicationserver', 'services'))
